...
app.get('/type/:type', (req, res) => {
  ...
  res.status(200).json(jokesFiltered);
});
...
app.put('/', (req, res) => {
  ...
  const actualJoke = jokes.find(joke => joke.id == id);

  const replacement = {
    id: id, 
    jokeText: jokeText || actualJoke.jokeText, 
    jokeType: jokeType || actualJoke.jokeType
  }
