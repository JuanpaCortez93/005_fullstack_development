...
app.post("/submit", (req, res) => {
  ...
  let adjetiveSelected = adj[Math.round(adj.length * Math.random())];
  let nounSelected = noun[Math.round(noun.length * Math.random())];
  let brand = adjetiveSelected + " " + nounSelected;
